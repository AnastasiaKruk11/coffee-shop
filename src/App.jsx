...
function App() {
  ...
  const [items, setItems] = useState([
    ...
    {id: 2, title: 'Кофейно-гранатовая карамель', description: 'Эспрессо, сок гранатовый, пюре роза-личи-грейпфрут, сироп сгущённое молоко, бадьян', image: './images/pomegranate.jpg', price: 9.5, chosen: false},
    {id: 3, title: 'Латте кленовый грильяж', description: 'Кофе, кленовый сироп, грильяжный топпинг, взрывная карамель', image: './images/maple.jpg', price: 9, chosen: false},
